...
public class PhotoPicker {
  ...
  public static class PhotoPickerBuilder {
    ...
    public PhotoPickerBuilder setPhotoType(int photoType) {
      mPickerOptionsBundle.putInt(PhotoPickerConstants.PHOTO_TYPE, photoType);
      return this;
    }
    ...
    public PhotoPickerBuilder setSelected(ArrayList<Photo> imagesUri) {
